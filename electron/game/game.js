...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('restart', d + 'assets/sprites/restart.png')
    this.load.image('gameover', d + 'assets/sprites/gameover.png')
    this.load.image('meat', d + 'assets/sprites/meat.png')
    this.load.spritesheet('doux', d + 'assets/sprites/doux.png', {frameWidth: 23.8, frameHeight: 17})
    this.load.spritesheet('bomb', d + 'assets/sprites/bombs.png', {frameWidth: 14.5, frameHeight: 12})
    this.load.audio('music', d + 'assets/music.mp3')
    this.load.audio('death', d + 'assets/death.mp3')
    this.load.audio('pickup', d + 'assets/pickup.wav')
  }
  ...
  update() {
    ...
    this.background4.tilePositionX += 8
